define([
    ...
    function(declare,SpatialReference,Extent,TiledMapServiceLayer,TileInfo){
	    return declare([TiledMapServiceLayer],{
	    	constructor:function(){
	    		...
	    		this.fullExtent=new Extent({xmin:-20037508.34,ymin:-20037508.34,xmax:20037508.34,ymax:20037508.34,spatialReference:{wkid:102100}});
				this.initialExtent=new Extent({xmin:-20037508.34,ymin:-20037508.34,xmax:20037508.34,ymax:20037508.34,spatialReference:{wkid:102100}});
				this.loaded=true;
				this.onLoad(this);
	    	},
	    	getTileUrl:function(level, row, col){
	    		var tileUrl,proxyurl = "/ISee/services/imageproxy?urls="; 
	    		tileUrl = proxyurl+"http://webst03.is.autonavi.com/appmaptile?style=6&x=" + col + "&y=" + row + "&z=" + level;
	    		tileUrl="http://localhost:8080/TileService/MapService/getTile?x="+col+"&y="+row+"&z="+level;
	    		tileUrl="http://localhost:8080/TileService/ImageryService/getTile?x="+col+"&y="+row+"&z="+level;
	    		return tileUrl;
